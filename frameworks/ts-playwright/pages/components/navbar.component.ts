...
export class NavbarComponent extends BaseComponent {
    ...
    private readonly notificationBadge: Locator = this.page.locator('.notification-badge');
    ...
    async expectNotificationBellVisible() {
        await expect(this.notificationBell).toBeVisible();
    }

    async expectNotificationBellHidden() {
        await expect(this.notificationBell).not.toBeVisible();
    }

    async expectNotificationBadgeVisible() {
        await expect(this.notificationBadge).toBeVisible();
    }

    async expectNotificationBadgeHidden() {
