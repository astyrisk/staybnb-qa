...
export class PropertyDetailsPage extends BasePage {
    ...
    readonly contactHostButton: Locator = this.page.getByRole("button", {name: "Contact Host"});
    readonly contactHostTextArea: Locator = this.page.getByPlaceholder("Write your message...");
    ...
    async sendMessageToHost(message: string) {
        ...
        await this.contactHostTextArea.fill(message);
